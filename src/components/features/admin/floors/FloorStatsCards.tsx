  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
      <div className="bg-surface-card p-3.5 sm:p-4 rounded-xl border border-border-subtle shadow-2xs flex items-center justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Tổng Tầng Lầu</p>
      ...
      <div className="bg-surface-card p-3.5 sm:p-4 rounded-xl border border-border-subtle shadow-2xs flex items-center justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Tầng Đang Hoạt Động</p>
      ...
      <div className="bg-surface-card p-3.5 sm:p-4 rounded-xl border border-border-subtle shadow-2xs flex items-center justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Tổng Thiết Bị Liên Kết</p>
